...
@Component
public class CompleteTemplateFinder implements IgnoredReplacementFinder {
    ...
    public List<ArticleReplacement> findIgnoredReplacements(String text) {
        ...
        matches.addAll(ArticleReplacementFinder.findReplacements(text, AUTOMATON_COMPLETE_TEMPLATE, ReplacementType.IGNORED));
        matches.addAll(ArticleReplacementFinder.findReplacements(text, AUTOMATON_CATEGORY, ReplacementType.IGNORED));
        return matches;
    }
