...
JMH library is used for benchmarking the time to find all the results in the sample of 50 pages.
Then, a barchart with a confidence interval is generated to compare the results visually.
