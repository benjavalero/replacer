...
import es.bvalero.replacer.finder.parser.ScannerSimple;
...
*/
    ...
    @Benchmark
    public void scannerSimple(Blackhole bh) {
        sampleContents.forEach(page -> new ScannerSimple(page.getContent()).scanTokens().forEach(bh::consume));
    }
