...
class AddedMisspellingListenerTest {
    ...
    void testGetAddedMisspellings() {
        ...
        expected.put(WikipediaLanguage.getDefault(), StandardType.of(ReplacementKind.SIMPLE, "C"));
        assertEquals(expected, addedMisspellingListener.getAddedMisspellings(map1, map2));
    }
