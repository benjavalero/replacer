...
class IndexablePageCacheRepositoryTest {
    ...
    void testFindDatabaseReplacements() {
        ...
        when(indexablePageRepository.findByPageIdInterval(WikipediaLanguage.getDefault(), 1, 1000))
            .thenReturn(List.of(page1));
        when(indexablePageRepository.findByPageIdInterval(WikipediaLanguage.getDefault(), 1001, 2000))
    ...
    void testFindDatabaseReplacementsWithEmptyLoad() {
        ...
        when(indexablePageRepository.findByPageIdInterval(WikipediaLanguage.getDefault(), 1, 2000))
