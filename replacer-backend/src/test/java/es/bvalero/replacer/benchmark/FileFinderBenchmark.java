...
public class FileFinderBenchmark {
    ...
    public void testBenchmark() throws IOException, WikipediaException, URISyntaxException {
        ...
        try (Stream<String> stream = Files.lines(Paths.get(FileFinderBenchmark.class.getResource("/es/bvalero/replacer/benchmark/sample-articles.txt").toURI()))) {
