...
@ContextConfiguration(classes = {UppercaseAfterFinder.class, MisspellingManager.class, WikipediaServiceImpl.class, WikipediaConfig.class},
...
public class UppercaseFinderBenchmark {
    ...
    public void testBenchmark() throws WikipediaException, URISyntaxException, IOException {
        ...
        try (Stream<String> stream = Files.lines(Paths.get(UppercaseFinderBenchmark.class.getResource("/es/bvalero/replacer/benchmark/sample-articles.txt").toURI()))) {
