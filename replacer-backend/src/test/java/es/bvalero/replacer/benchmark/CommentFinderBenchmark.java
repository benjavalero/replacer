...
public class CommentFinderBenchmark {
    ...
    public void testBenchmark() throws IOException, WikipediaException, URISyntaxException {
        ...
        try (Stream<String> stream = Files.lines(Paths.get(CommentFinderBenchmark.class.getResource("/es/bvalero/replacer/benchmark/sample-articles.txt").toURI()))) {
